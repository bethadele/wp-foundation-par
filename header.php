...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<title><?php if(!is_home() && !is_front_page()) { wp_title('', true, 'right'); } ?><?php get_bloginfo('name') ?> &raquo; <?php get_bloginfo('description') ?></title>
    ...
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Robot|Roboto+Slab" />
		...
		<div class="row container">
			<div class="twelve columns">
				<header role="banner" id="top-header">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pagans-against-racism.png" class="site-graphic" />
					<div class="siteinfo">
